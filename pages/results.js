    ...
    <Row>
      <Col style={{ paddingTop: "2rem" }}>
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <h1>National Party ( +10 ) You should consider voting National</h1>
            </Card.Title>
            <Card.Text>
    ...
    <Row>
      <Col style={{ paddingTop: "2rem" }}>
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <h1>Advance New Zealand ( 0 ) This party does as much good as bad </h1>
            </Card.Title>
            <Card.Text>
    ...
    <Row>
      <Col style={{ paddingTop: "2rem" }}>
        <Card>
          ...
          <Card.Body>
            <Card.Title>
              <h1>Labour Party ( -10 ) You probably shouldn't vote for Labour</h1>
            </Card.Title>
            <Card.Text>
